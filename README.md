...
Avaliação da Saúde de Componentes React por Meio de Métricas Estruturais em Sistemas Robustos.
...
O experimento está relacionado ao ecossistema React.js, um dos frameworks mais utilizados no desenvolvimento frontend moderno. Apesar da sua adoção massiva, observa-se que a qualidade dos componentes - unidade central da arquitetura React - nem sempre acompanha a velocidade de crescimento dos projetos, levando a problemas de manutenção, regressões, complexidade excessiva e acoplamento inadequado. Este experimento busca propor e testar métricas estruturais que possam servir como indicadores confiáveis de saúde desses componentes.

## 2. Contexto e problema
### 2.1 Descrição do problema / oportunidade

Projetos React de médio e grande porte frequentemente sofrem com componentes degradados ao longo do tempo, gerando sintomas como:
componentes excessivamente grandes e difíceis de realizar manutenção;
acoplamento elevado entre camadas e hooks;
alta complexidade cognitiva do fluxo lógico interno;
dificuldade de refatoração e aumento de bugs.

Hoje não existe um conjunto amplamente aceito de métricas estruturais específicas para componentes React que permita medir sua saúde de maneira objetiva, semelhante ao papel das CK Metrics para classes em POO.

A oportunidade está em propor um conjunto inicial de métricas estruturais adaptadas ao paradigma de componentes e verificar experimentalmente se elas permitem identificar componentes saudáveis vs. problemáticos.
...
1. Escopo e contexto do experimento
